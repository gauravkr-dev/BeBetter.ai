...
export default function FooterSection() {
    return (
        <footer className="py-8 md:py-12 dark:bg-[#0A0A0A]">
            <div className="mx-auto max-w-6xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} BeBeeter, All rights reserved</span>
            </div>
        </footer>
    )
}