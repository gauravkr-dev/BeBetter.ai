            ...
            >
                ...
                <div className="relative mx-auto flex min-h-[70vh] max-w-7xl flex-col items-center justify-center px-4 pt-24 pb-24 md:pt-32 md:pb-32">
                    ...
                    <motion.h1
                        ...
                        viewport={{ once: true }}
                        className={cn(
                            "relative z-10 mx-auto mt-24 max-w-3xl bg-clip-text pb-2 text-center text-5xl leading-[1.15] font-medium tracking-tighter text-balance text-transparent md:text-[4.2rem]",
                            isLight
                    ...
                    >
                        Become Better. Get Better Opportunities.
                    </motion.h1>
                    <motion.p
                        initial={{
                            y: 10,
                        ...
                        viewport={{ once: true }}
                        className={cn(
                            "relative z-10 mx-auto mb-12 mt-4 max-w-sm bg-clip-text text-center text-[0.8rem] leading-relaxed text-balance text-transparent sm:max-w-[32rem] sm:text-[0.87rem] lg:text-[1rem]",
                            isLight
                    ...
                    >
                        AI-powered interviews, mock tests, resume insights, and job discovery — designed to accelerate your career.
                    </motion.p>
                    <motion.div
                        initial={{
                            y: 5,
